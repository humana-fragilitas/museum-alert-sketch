...
void Sensor::configure(const AwsIotConfiguration& configuration) {
...
String Sensor::setBroadcastUrl(const String& url) {
...
bool Sensor::send(MqttMessageType type, const String& correlationId, const JsonVariant& payload) {
...
bool Sensor::send(MqttMessageType type, const String& correlationId) {
  return send(type, correlationId, JsonDocument().to<JsonVariant>());
};

bool Sensor::send(MqttMessageType type, const JsonVariant& payload) {
  return send(type, "", payload);
};

void Sensor::parseMqttCommand(const String& jsonPayload) {
...
bool Sensor::onReset(const String& correlationId) {
...
bool Sensor::onGetConfiguration(const String& correlationId) {
...
bool Sensor::onSetConfiguration(const JsonVariant& doc, const String& correlationId) {
